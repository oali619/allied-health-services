...
import { referrerType, insuranceTypes, waiverTypes } from '../constants'
import { Resend } from 'resend';

// TODO: fix the form submission and add the email sending functionality
...
export default function Referral() {
    ...
    async function handleSubmit(e) {
        e.preventDefault()
        const { referrername, referrernumber, referrerEmail, fullname, dob, number, email, attachments, comments, address, city, region, county, postalcode } = e.target.form.elements
        console.log({
            referrername: referrername.value,
            referrernumber: referrernumber.value,
            referrerEmail: referrerEmail.value,
    ...
    return (
        <form className='py-[100px] sm:pb-[175px] mx-[15px]' id='referral_form'>
            <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-4 grid place-items-center">
                    <h1 className="text-4xl font-bold leading-7 text-gray-900">Refer A Client</h1>
                    <p className="mt-1 text-sm leading-6 text-gray-600 text-center">
                        We thank you for referring a client to us. Please fill out the form below.
                    </p>
                </div>

                <h2 className="mt-10 text-base font-semibold leading-7 text-gray-900">Referrer Information</h2>
                <div className="mt-10 grid grid-cols-2 sm:grid-cols-6 gap-x-4">
                    <Listbox name="referrertype" value={selectedReferrer} onChange={setSelectedReferrer}>
                        <div className='col-span-1'>
                            <Label className="block text-sm font-medium leading-6 text-gray-900">Referrer Type</Label>
                            <div className="relative mt-2">
                                <ListboxButton className="w-full cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-sm sm:leading-6">
                                    <span className="flex items-center">
                                        <span className="ml-3 block truncate">{selectedReferrer.type}</span>
                                    </span>
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <div className="mt-10 grid grid-cols-2 sm:grid-cols-6 gap-x-4 gap-y-2">
                        ...
                        <div className='col-span-1 sm:col-span-2'>
                            <Listbox value={selectedInsurance} onChange={setSelectedInsurance}>
                                <Label className="block text-sm font-medium leading-6 text-gray-900">Insurance</Label>
                                <div className="relative mt-2">
                                    <ListboxButton className="relative w-full cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-sm sm:leading-6">
                                        <span className="flex items-center">
                                            <span className="ml-3 block truncate">{selectedInsurance.type}</span>
                                        </span>
                                        <span className="pointer-events-none absolute inset-y-0 right-0 ml-3 flex items-center pr-2">
                        ...
                        <div className='col-span-1 sm:col-span-2'>
                            <Listbox value={selectedWaiver} onChange={setSelectedWaiver}>
                                <Label className="block text-sm font-medium leading-6 text-gray-900">Waiver Type</Label>
                                <div className="relative mt-2">
                                    <ListboxButton className="relative w-full cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-sm sm:leading-6">
                                        <span className="flex items-center">
                                            <span className="ml-3 block truncate">{selectedWaiver.type}</span>
                                        </span>
                                        <span className="pointer-events-none absolute inset-y-0 right-0 ml-3 flex items-center pr-2">
                                            <ChevronUpDownIcon aria-hidden="true" className="h-5 w-5 text-gray-400" />
                                        </span>
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-600">
                        Let us know anything else you think we should know about the client. Feel free to attach any documents here as well.
                    </p>
            ...
            <div className="mt-6 flex items-center justify-end gap-x-6">
                <button type="button" className="text-sm font-semibold leading-6 text-gray-900" onClick={handleClear}>
                    Clear
                </button>
                <button
                    type="submit"
