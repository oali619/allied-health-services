			...
			<div className='space-y-12'>
				<div className='border-b border-gray-900/10 pb-4 grid place-items-center'>
					...
					<p className='mt-1 text-sm leading-6 text-gray-600 text-center'>
						We thank you for referring a client to us. Please fill out the form
						below.
					</p>
				</div>
				...
				<div className='border-b border-gray-900/10 pb-12'>
					...
					<p className='mt-1 text-sm leading-6 text-gray-600'>
						Let us know anything else you think we should know about the client.
						Feel free to attach any documents here as well.
					</p>
